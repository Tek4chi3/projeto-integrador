...
public class ExameFísico {
    String postura;
    String nívelDeConsciência;
    int escoreCorporal;
    double tr;
    String fr;
    String fc;
    ...
    public String getNívelDeConsciência() {
        return nívelDeConsciência;
    }

    public void setNívelDeConsciência(String nívelDeConsciência) {
        this.nívelDeConsciência = nívelDeConsciência;
    }
