...
public class AnamneseGeral {
    ...
    String históricoMédicoProgresso;
    String alimentação;
    String contactantes;
    String ambienteEmQueVive;
    String vacinação;
    String vermifugação;
    ...
    public String getHistóricoMédicoProgresso() {
        return históricoMédicoProgresso;
    }

    public void setHistóricoMédicoProgresso(String históricoMédicoProgresso) {
        this.históricoMédicoProgresso = históricoMédicoProgresso;
    }
